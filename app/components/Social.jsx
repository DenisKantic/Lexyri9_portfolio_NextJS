             ...
             bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 ">
                ...
                <motion.div className="flex justify-between items-center mt-10
                  ...
                  > {/*card item */}
                        ...
                        <Image src="/images/mob1.webp" alt="instagram lexyri9" unoptimized width={200} height={400}
                    ...
                    <div className="flex flex-col items-center justify-center xxs:w-[80%] sm:w-[45%] md:w-[20%]"> {/*card item */}
                        <Image src="/images/mob2.webp" alt="tiktok lexyri9" unoptimized width={200} height={400}
                        className="h-auto w-full object-contain"/>
                    ...
                    <div className="flex flex-col items-center justify-center xxs:w-[80%] sm:w-[45%] md:w-[20%]"> {/*card item */}
                        <Image src="/images/mob3.webp" alt="youtube lexyri9" unoptimized width={200} height={400}
                        className="h-auto w-full object-contain"/>

                        <a className="px-4 py-2 bg-white rounded-xl flex 
                        flex-row items-center justify-center mt-5"
                        href="https://www.youtube.com/channel/UCznHaNy4Q_4DOdVx7EiCANA" target="_blank">
                            <Image src="/images/youtube.webp" alt="lexyri9" unoptimized width={30} height={30}/>
                            <p className="text-lg ml-3 xxs:text-md sm:text-sm md:text-md">@lexyri9</p>
                        </a>
